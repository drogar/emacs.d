;; Set staring position and width and height of emacs window
...
(defun linum-format-func (line)
  ;(concat
   (propertize (format linum-format-fmt line) 'face 'mode-line))
...
;;; I prefer cmd key for meta - but this still does not work
...
;;some custom functions, stolen from internet
